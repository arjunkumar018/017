<%@ Page Title="" Language="C#" MasterPageFile="~/UserPannel.Master" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="Revision.UserLogin" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                  <h3 class="mb-3" style="text-align:center; background-color:aqua;color:red; font-size:xx-large;">USER<span style="color:blue;">LOGIN</span></h3>
...
<%--                                                    <input id="PASS" runat="server" type="text" class="form-control" placeholder="Enter Password">--%>
                                            ...
                                            <div class="col-sm-6">
                                                <asp:LinkButton ID="frhbtn" runat="server" Text="Forgate Password" herf="ChangePass.aspx" class="float-end text-primary"></asp:LinkButton>
